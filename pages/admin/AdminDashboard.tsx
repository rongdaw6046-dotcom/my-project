...
import { List, Users, DollarSign, CheckCircle, Calendar, Clock, ArrowRight, PieChart, TrendingUp, UserPlus, AlertCircle } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <Link to="/admin/users" className="flex items-center p-4 bg-white border border-gray-200 rounded-xl text-gray-800 shadow-sm hover:shadow-md transition-all transform hover:-translate-y-0.5">
                    <div className="p-3 bg-gray-100 rounded-lg mr-4 text-gray-600">
                        <UserPlus size={24} />
                    </div>
                    <div>
                        <h4 className="font-bold">เพิ่มผู้ใช้งาน</h4>
                        <p className="text-gray-500 text-sm">จัดการสิทธิ์บุคลากร</p>
                    </div>
                </Link>
            </div>
        </div>
