        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
            ...
            <form onSubmit={handleFormSubmit} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">LINE User ID (U...)</label>
                <div className="mt-1 flex rounded-md shadow-sm">
                  <input type="text" className="flex-1 min-w-0 block w-full px-3 py-2 rounded-md border border-gray-300 focus:ring-orange-500 focus:border-orange-500 sm:text-sm font-mono placeholder-gray-400"
                    value={userForm.lineUserId} onChange={e => setUserForm({ ...userForm, lineUserId: e.target.value })} placeholder="U1234567890..." />
                </div>
                <p className="mt-1 text-xs text-gray-500">สำหรับรับการแจ้งเตือนผ่าน LINE บอท</p>
              </div>
              <div>
